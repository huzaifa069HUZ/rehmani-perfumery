  ...
  return (
    <>
      ...
      <main className="store-page min-h-screen">
        ...
        <section id="our-stores" className="relative w-full bg-[#F6F2EB] py-16 sm:py-20 lg:py-24 overflow-hidden">
          ...
          <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
            ...
            >
              ...
              <a 
                href="https://wa.me/918340783679" 
                target="_blank" 
                rel="noopener noreferrer"
                className="group relative flex items-center gap-2 px-6 py-3 text-white text-[12px] tracking-[0.15em] uppercase font-extrabold rounded-xl overflow-hidden transition-all duration-500 shadow-[0_8px_20px_rgba(32,181,88,0.3)] hover:shadow-[0_12px_25px_rgba(32,181,88,0.5)] hover:-translate-y-1 border border-[#20B558]/50"
                style={{ background: 'linear-gradient(to right, #1FA351, #0E6D58)' }}
              >
                {/* WhatsApp SVG Icon */}
                <svg className="w-[18px] h-[18px] relative z-10 text-white transform group-hover:scale-110 transition-transform duration-500" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span className="relative z-10 drop-shadow-sm ml-1">Chat With Us</span>
              </a>
            </motion.div>
        ...
        <section 
          className="relative w-full bg-gradient-to-b from-[#FDFBF7] to-[#F1EBE1] overflow-hidden flex flex-col items-center"
        ...
        >
          ...
          <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div 
              className="relative w-full h-[450px] sm:h-[500px] flex items-center justify-center [perspective:1200px]"
            >
              {[
                ...
                { title: 'Exclusive Offers', desc: 'Enjoy special walk-in discounts and complimentary samples strictly reserved for physical store visitors.', img: '/assets/minimal.png' },
