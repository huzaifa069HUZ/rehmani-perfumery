...
/* ── Product Card (inline) ─────────────────────────── */
function BakhoorCard({ product, onOpen }: { product: Product; onOpen: (p: Product) => void }) {
...
export default function BakhoorPage() {
  ...
  const filtered = useMemo(() => {
    // Filter for bakhoor products only
    let list = dbProducts.filter(p => {
      ...
      return type === 'bakhoor' || 
             cat === 'bakhoor' ||
             name.includes('bakhoor') || name.includes('bukhoor');
    });
    ...
    <div className="al-root">
      ...
      <div className="incense-hero">
        ...
        <div className="incense-hero-content">
          <p className="incense-hero-tag">DIVINE ARABIAN FRAGRANCE</p>
          <h1 className="incense-hero-title">Premium Bakhoor</h1>
      ...
      <div className="incense-features">
        {[
          ...
          { title: 'RICH AROMATIC SMOKE', desc: 'Fills every corner', icon: 'M12 2v6m0 4v6m-6-9h12' },
        ...
        <div className="al-controls-inner">
          ...
          <div className="al-search-wrap">
            ...
            <input
              ...
              type="text"
              placeholder="Search bakhoor, fragrances…"
              value={search}
              onChange={e => setSearch(e.target.value)}
              aria-label="Search bakhoor"
            />
            {search && (
        ...
        <div className="al-content">
          ...
          <div className="al-results-bar">
            <p className="al-results-count">
              {filtered.length === 0 ? 'No bakhoor found' : `${filtered.length} Product${filtered.length !== 1 ? 's' : ''}`}
          ...
          {filtered.length === 0 ? (
            <div className="al-empty">
              ...
              <h3 className="al-empty-title">No bakhoor found</h3>
