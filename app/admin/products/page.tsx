                  ...
                  <div key={product.id} className="product-row" style={{ animationDelay: `${idx * 0.04}s`, animation: 'fadeInUp 0.3s ease both' }}>
                    ...
                    <div className="prd-meta">
                      ...
                      <div className="prd-type" style={{ minWidth: '90px' }}>
                        ...
                        background: product.type === 'perfume' ? 'rgba(56, 189, 248, 0.15)' : product.type === 'bakhoor' ? 'rgba(168,132,42,0.15)' : product.type === 'incense' ? 'rgba(234,179,8,0.15)' : product.type === 'giftset' ? 'rgba(236,72,153,0.15)' : 'rgba(212,175,95,0.15)',
                        color: product.type === 'perfume' ? '#0ea5e9' : product.type === 'bakhoor' ? '#a8842a' : product.type === 'incense' ? '#ca8a04' : product.type === 'giftset' ? '#ec4899' : '#d4af5f', border: `1px solid ${product.type === 'perfume' ? 'rgba(56, 189, 248, 0.3)' : product.type === 'bakhoor' ? 'rgba(168,132,42,0.3)' : product.type === 'incense' ? 'rgba(234,179,8,0.3)' : product.type === 'giftset' ? 'rgba(236,72,153,0.3)' : 'rgba(212,175,95,0.3)'}`
                      }}>
                        {product.type === 'perfume' ? 'Perfume' : product.type === 'bakhoor' ? 'Bakhoor' : product.type === 'incense' ? 'Incense' : product.type === 'giftset' ? 'Gift Set' : 'Attar'}
                      </span>
                    </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <Link href="/admin/products/add?type=giftset" 
                style={{
                   display: 'flex', alignItems: 'center', gap: '16px', padding: '16px', borderRadius: '12px',
                   border: '1px solid #e2e8f0', background: '#f8fafc', textDecoration: 'none', transition: 'all 0.2s'
                }}
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '15px', fontWeight: '600', color: '#1e293b', marginBottom: '2px' }}>Premium Gift Set</div>
                  <div style={{ fontSize: '12px', color: '#64748b' }}>Curated gifting collections</div>
                </div>
              </Link>
            </div>
          </div>
