...
const attarsJsonLd = {
  ...
  description: 'Shop the finest selection of pure, alcohol-free Arabian attars from Rahmani Perfumery in Patna, Bihar.',
  url: 'https://www.rahmaniperfumery.com/attars',
  publisher: {
    '@type': 'Organization',
        ...
        <div className="seo-content-inner">
          ...
          <div className="seo-columns">
            <div className="seo-col">
              ...
              <p>
                <strong>Rahmani Perfumery</strong> (also known as <strong>Rehmani Perfumery</strong>) offers the most exquisite collection of <em>pure, alcohol-free Arabian attars</em> in Patna, Bihar. Our handcrafted attar oils include deep oud, delicate floral, warm musk, spicy, and fresh citrus fragrances — each crafted using traditional distillation techniques.
              </p>
              <p>
