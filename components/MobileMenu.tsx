          ...
          >
            <div className="mm-inner">
              ...
              <div className="mm-scroll-area">
                ...
                <div className="mm-group">
                  <div className="mm-group-header">
                    <Link href="/about-us" className="mm-link" onClick={onClose}>ABOUT</Link>
                  </div>
                </div>

                <div className="mm-group">
                  <div className="mm-group-header">
                    <Link href="/gifting" className="mm-link" onClick={onClose}>GIFTING</Link>
                  </div>
                </div>

                <div className="mm-group">
                  <div className="mm-group-header">
                    <Link href="/incense-sticks" className="mm-link" onClick={onClose}>INCENSE STICKS</Link>
                  </div>
                </div>
