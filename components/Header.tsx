    ...
    <header id="main-header" className={`main-header${scrolled ? ' scrolled' : ''}`}>
      <div className="header-inner">
        ...
        <a href="#" className="logo-text" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
          <Image src="/logo.png" alt="Rehmani Logo" width={30} height={45} style={{ objectFit: 'contain', height: '40px', width: 'auto' }} priority />
          <span>REHMANI <span className="logo-gold">PERFUMERY</span></span>
        </a>
